odoo.define('product.product_custom_pricelist', function (require) {
'use strict';
...
var GeneratePriceList = AbstractAction.extend(StandaloneFieldManagerMixin, {
    ...
    willStart: function () {
        ...
        const fieldSetup = getPricelist.then(pricelistIds => {
            ...
            this.customerMany2One = new FieldMany2One(this, 'customer_id', record, {
                mode: 'edit',
                attrs: {
                    can_create: false,
                    can_write: false,
            ...
            this._registerWidget(recordID, 'customer_id', this.customerMany2One);
    ...
    _renderComponent: function () {
        ...
        this.customerMany2One.appendTo($searchview.find('.o_customer'));
    ...
    _onFieldChanged: function (event) {
        ...
        this.context.customer_id = event.data.changes.customer_id.id;
...
core.action_registry.add('product_custom_pricelist', GeneratePriceList);
